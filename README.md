# 455-project
## Summary
Used resnet to do blood cell image classification. Applied transfer learning and draw loss decreasing graph and accuracy increasing graph. The best accuracy is 0.714, which is an acceptable result. The video presentation link is [here](https://youtu.be/5fSzZWCOXqE). The original source code is under the category. 
